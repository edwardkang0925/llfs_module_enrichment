...
PROJECT_NAME="results_MMAP_PASCAL_11_traits_oct_8_CMA_threshold"
...
INPUT_PATH="/Users/test/projects/LLFSPascalModuleEnrichment/0.ORA input/results_MMAP_PASCAL_11_traits_oct_8_CMA_threshold" # path to folder of module genes
REFERENCE_PATH="/Users/test/projects/LLFSPascalModuleEnrichment/0.backgroundGenes/results_MMAP_PASCAL_11_traits_oct_8_CMA_threshold" # path to folder of background gene lists
...
SUMMARIES_PATH="GO_summaries" # will be created if does not exist
